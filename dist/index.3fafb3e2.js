...
_parcelHelpers.export(exports, "HTMLBuilder", function () {
  return HTMLBuilder;
});
const HTMLBuilder = {
...
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "Header", function () {
  return Header;
});
var _libsHtml_builder = require("../../libs/html_builder");
require("./header.scss");
const Header = () => {
  return _libsHtml_builder.HTMLBuilder.build("header", "", {
    class: "header"
  }, [["img", "", {
    src: "https://mohamed28.github.io/app/assets/images/icons/head/home-tab.png",
    alt: "Logo"
